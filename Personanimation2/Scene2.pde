void Scene2(){
  ...
  latarBelakang_scene2();
  sceneDua();
}


void latarBelakang_scene2(){
//layar atas
  fill(172, 230, 200);
  noStroke();
  rect(0,0,900,450);
...
//bulan sabit
  ...
  fill(172, 230, 200);
  ellipse(225, 95, 110, 110);

//title
  textFont(tulisan);
  fill(181, 114, 164);
  text("Puasa Ramadhan", 420, 120);
}
...
void kontensatu(){
  textFont(tulisan2);
  fill(#734c21);
  text("Puasa adalah dimana manusia menahan", 300, 340);
  text("diri dari makan, minum, dan perbuatan",307,370);
  text("(hawa nafsu).",390,400);
}

void kontendua(){
  textFont(tulisan2);
  fill(#734c21);
  text("Ramadhan adalah bulan kesembilan dalam", 300, 340);
  text("kalender Islam dimana umat Muslim",310,370);
  text("menjalankan salah satu rukun islam",310,400);
  text("untuk beribadah Puasa selama 30 hari.",305,430);
}

void mainkonten(){
  textFont(tulisan2);
  fill(#734c21);
  text("Puasa Ramadhan adalah Ibadah Puasa", 300, 330);
  text("yang dilakukan oleh umat Muslim selama", 300,360);
  text("bulan Ramadhan dalam menjalankan",310,390);
  text("rukun Islam yang ketiga.",360,420);
}
