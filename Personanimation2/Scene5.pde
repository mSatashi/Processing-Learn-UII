...
//layar atas
  fill(222, 172, 230);
  noStroke();
  rect(450,200,900,600);

//layar bawah
  fill(172, 230, 200);
  noStroke();
  rect(450,550,900,200);
  awan();
  judul();
  orang();
  scene4();
...
void judul(){
  ...
  textFont(tulisan);
  fill(000000);
  text("Don'ts During Ramadhan", 610, 85);
  textFont(tulisan2);
  fill(000000);
  text("(5 Hal yang tidak boleh dilakukan saat Ramadhan)", 600, 120);
}
...
//kaki kanan
 ...
 fill(255); //mata putih
  ...
  textFont(tulisan4);
  fill(000000);
  text("Makan minum dengan sengaja", 400, 265);
  }
  ...
  textFont(tulisan4);
  fill(000000);
  text("Muntah dengan sengaja", 370, 365);
  }
  ...
  textFont(tulisan4);
  fill(000000);
  text("Berkata keji dan berbuat", 373, 455);
  text("maksiat", 370, 475);
  }
  ...
  textFont(tulisan4);
  fill(000000);
  text("Melakukan hal tercela", 915, 300);
  }
  ...
  textFont(tulisan4);
  fill(000000);
  text("Meninggalkan shalat", 910, 445);
  text("wajib", 920, 465);  
}
